...
assert.equal(normalizer.normalize('ワープ特急時間殺人事件BokGak'),'ワープ特急殺人事件 BokGak');
assert.equal(normalizer.normalize('ワープ特急時間殺人事件 BokGak'),'ワープ特急殺人事件 BokGak');
assert.ok(normalizer.names.includes('ワープ特急殺人事件 BokGak'));
