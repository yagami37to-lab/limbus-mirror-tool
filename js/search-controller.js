...
$$('.browse-category-tab').forEach(button=>button.classList.toggle('active',button.dataset.categoryId===''));if(mobileBrowseCategory)mobileBrowseCategory.value='';const initialCurrent=$('[data-current-browse-category]');if(initialCurrent){initialCurrent.textContent='すべて';delete initialCurrent.dataset.categoryId;}
